...

{
    public class PlanItemDTO
    {
        ...
        public PlanItemDTO(int classId, string className, List<TypeItemForClassDTO> typeItems, decimal price, int capacity, DateTime date, string goal)
        {
            ClassId = classId;
            Name = className;
            TypeItems = typeItems;
        ...
        // TypeItems for display
        public List<TypeItemForClassDTO> TypeItems { get; set; }
