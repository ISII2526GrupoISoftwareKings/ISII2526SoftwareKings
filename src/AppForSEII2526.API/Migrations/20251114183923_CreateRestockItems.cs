...
{
    /// <inheritdoc />
    public partial class CreateRestockItems : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PaymentMethodType = table.Column<string>(type: "nvarchar(13)", maxLength: 13, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Restocks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Restocks_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HealthIssues = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlanItems", x => new { x.PlanId, x.ClassId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RestockPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestockItems", x => new { x.ItemId, x.RestockId });
                    table.ForeignKey(
                        name: "FK_RestockItems_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RestockItems_Restocks_RestockId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RestockItems_RestockId",
                table: "RestockItems",
                column: "RestockId");

            migrationBuilder.CreateIndex(
                name: "IX_Restocks_ApplicationUserId",
                table: "Restocks",
